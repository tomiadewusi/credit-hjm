...
comparing structurally similar payoffs. By design, our vanilla CLN will be an 
excellent control variate for our exotic CLN. 
...
recovery rate. Because the exotic structure modifies redemption by a fractional
factor depending on spread behaviour, the correlation between $Y$ and $C$ is
naturally high. Control variates therefore yield strong variance reduction.
