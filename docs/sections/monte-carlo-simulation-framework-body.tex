...
implementation. Instead, the \emph{model CDS spread} at time $t_i$ is defined
pathwise by
\[
...
This simplified approach is appropriate here because the focus is on the
Monte Carlo implementation of the HJM hazard model,
